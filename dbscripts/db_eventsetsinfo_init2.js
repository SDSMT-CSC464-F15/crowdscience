...
db.eventsetsinfo.insert({ 
id : "pinebeetle", name : "Pine Beetle Spread",
details : [ { id : "tree", name : "Tree Species Targeted", type : "shorttext"},
			{ id : "count", name : "Number of Infected Trees", type : "number", min : "0", max : "none", step : "1"},
			{ id : "description", name : "Additional Details", type : "longtext"},
			{ id : "date", name : "Date", type : "date" } ]
			});
